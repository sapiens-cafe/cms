...
export interface CardsRayCard extends Struct.ComponentSchema {
  ...
  attributes: {
    ...
    description: Schema.Attribute.String;
    menu_food_images: Schema.Attribute.Media<
...
export interface DynamicZoneGeneralConditions extends Struct.ComponentSchema {
  collectionName: 'components_dynamic_zone_general_conditions';
  info: {
    description: '';
    displayName: 'General_Conditions';
    icon: '';
  };
  attributes: {
    title: Schema.Attribute.String;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ComponentSchemas {
      ...
      'dynamic-zone.general-conditions': DynamicZoneGeneralConditions;
