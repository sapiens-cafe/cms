...
export interface ApiEventSubscriberEventSubscriber
  extends Struct.CollectionTypeSchema {
  collectionName: 'event_subscribers';
  info: {
    displayName: 'event-subscriber';
    pluralName: 'event-subscribers';
    singularName: 'event-subscriber';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    email: Schema.Attribute.Email;
    event: Schema.Attribute.Relation<'manyToOne', 'api::product.product'>;
    firstname: Schema.Attribute.String;
    lastname: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::event-subscriber.event-subscriber'
    > &
      Schema.Attribute.Private;
...
export interface ApiFoodMenuFoodMenu extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    dynamic_zone: Schema.Attribute.DynamicZone<
      [
        ...
        'dynamic-zone.form-next-to-section',
        'dynamic-zone.faq',
        'dynamic-zone.general-conditions',
      ]
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    event_subscribers: Schema.Attribute.Relation<
      'oneToMany',
      'api::event-subscriber.event-subscriber'
    >;
    featured: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::event-subscriber.event-subscriber': ApiEventSubscriberEventSubscriber;
